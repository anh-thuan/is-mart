        ...
        <div class="main-content fl-right">
            ...
            <div class="section" id="feature-product-wp">
                ...
                <div class="section-detail">
                    <ul class="list-item">
                        <li>
                            <a href="?mod=users&action=detail_product" title="" class="thumb">
                                <img src="public/images/img-pro-05.png">
                            </a>
                            <a href="?mod=users&action=detail_product" title="" class="product-name">Laptop Lenovo IdeaPad 120S</a>
                            <div class="price">
                                <span class="new">5.190.000đ</span>
                                <span class="old">6.190.000đ</span>
                            </div>
                            <div class="action clearfix">
                                <a href="?mod=users&action=cart" title="" class="add-cart fl-left">Thêm giỏ hàng</a>
                                <a href="?mod=users&action=checkout" title="" class="buy-now fl-right">Mua ngay</a>
                            </div>
                        </li>
                        <li>
