		...
		<div class="screen__content">
            <form class="login" id="form-login" action="" method="POST">
				<div class="login__field">
					...
					<input type="password" class="login__input" name="password" id="username" value="<?php echo set_value('password');?>" placeholder="New Password"><br><br><br>
					<div class="text-danger">
                    <?php echo form_error('password')?>
                    </div>		
				</div>
				<input class="button login__submit" type="submit" id="btn-login" name="btn-new-pass" value="Create new password">	
				</input><br>
					<div class="text-danger">
